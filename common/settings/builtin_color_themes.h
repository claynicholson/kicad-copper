...
// kicad-copper: "Copper Dark" built-in theme. A dark schematic + board palette
// using the Copper brand accent #c8783c (200,120,60) for selection / highlight /
// cursor / ratsnest-style slots. Mirrors the full key set of s_defaultTheme so
// every required color slot is present (copied from s_defaultTheme then recolored).
// Brand palette references (see eeschema/widgets/copper_chat_widgets.h):
//   accent #c8783c (200,120,60), accent-hover #dc8c50 (220,140,80),
//   dark BG #161a1a (22,26,26) / #1a1a1e (26,26,30), light text #dcdce1 (220,220,225).
static const std::map<int, COLOR4D> s_copperDarkTheme =
        {
            // ── Schematic ──────────────────────────────────────────────────
            { LAYER_SCHEMATIC_ANCHOR,     CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_SCHEMATIC_AUX_ITEMS,  CSS_COLOR( 220, 220, 225, 1 ) },
            { LAYER_SCHEMATIC_BACKGROUND, CSS_COLOR( 26,  26,  30,  1 ) },
            { LAYER_HOVERED,              CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_BRIGHTENED,           CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_BUS,                  CSS_COLOR( 90,  150, 220, 1 ) },
            { LAYER_BUS_JUNCTION,         CSS_COLOR( 90,  150, 220, 1 ) },
            { LAYER_DEVICE_BACKGROUND,    CSS_COLOR( 38,  34,  28,  1 ) },
            { LAYER_DEVICE,               CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_SCHEMATIC_CURSOR,     CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_DNP_MARKER,           CSS_COLOR( 220, 80,  70,  0.85 ) },
            { LAYER_EXCLUDED_FROM_SIM,    CSS_COLOR( 110, 110, 120, 0.95 ) },
            { LAYER_ERC_ERR,              CSS_COLOR( 230, 80,  70,  0.8 ) },
            { LAYER_ERC_WARN,             CSS_COLOR( 220, 170, 70,  0.8 ) },
            { LAYER_ERC_EXCLUSION,        CSS_COLOR( 110, 110, 120, 0.8 ) },
            { LAYER_FIELDS,               CSS_COLOR( 190, 150, 210, 1 ) },
            { LAYER_SCHEMATIC_GRID,       CSS_COLOR( 55,  55,  62,  1 ) },
            { LAYER_SCHEMATIC_GRID_AXES,  CSS_COLOR( 90,  100, 130, 1 ) },
            { LAYER_HIDDEN,               CSS_COLOR( 90,  90,  100, 1 ) },
            { LAYER_JUNCTION,             CSS_COLOR( 90,  190, 120, 1 ) },
            { LAYER_GLOBLABEL,            CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_HIERLABEL,            CSS_COLOR( 200, 170, 100, 1 ) },
            { LAYER_LOCLABEL,             CSS_COLOR( 220, 220, 225, 1 ) },
            { LAYER_NETCLASS_REFS,        CSS_COLOR( 150, 150, 158, 1 ) },
            { LAYER_DRAG_NET_COLLISION,   CSS_COLOR( 230, 80,  70,  0.8 ) },
            { LAYER_RULE_AREAS,           CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_NOCONNECT,            CSS_COLOR( 90,  150, 220, 1 ) },
            { LAYER_NOTES,                CSS_COLOR( 110, 160, 230, 1 ) },
            { LAYER_PRIVATE_NOTES,        CSS_COLOR( 130, 130, 230, 1 ) },
            { LAYER_NOTES_BACKGROUND,     CSS_COLOR( 0,   0,   0,   0 ) },
            { LAYER_PIN,                  CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_PINNAM,               CSS_COLOR( 90,  190, 190, 1 ) },
            { LAYER_PINNUM,               CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_REFERENCEPART,        CSS_COLOR( 90,  190, 190, 1 ) },
            { LAYER_SELECTION_SHADOWS,    COLOR4D( .78, .47, .24, 0.8 ) },
            { LAYER_SHEET,                CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_SHEET_BACKGROUND,     CSS_COLOR( 26,  26,  30,  0 ) },
            { LAYER_SHEETFILENAME,        CSS_COLOR( 200, 170, 100, 1 ) },
            { LAYER_SHEETFIELDS,          CSS_COLOR( 190, 150, 210, 1 ) },
            { LAYER_SHEETLABEL,           CSS_COLOR( 90,  190, 190, 1 ) },
            { LAYER_SHEETNAME,            CSS_COLOR( 90,  190, 190, 1 ) },
            { LAYER_VALUEPART,            CSS_COLOR( 90,  190, 190, 1 ) },
            { LAYER_WIRE,                 CSS_COLOR( 90,  190, 120, 1 ) },
            { LAYER_SCHEMATIC_DRAWINGSHEET, CSS_COLOR( 200, 120, 60, 1 ) },
            { LAYER_SCHEMATIC_PAGE_LIMITS,  CSS_COLOR( 55,  55,  62, 1 ) },
            { LAYER_OP_VOLTAGES,            CSS_COLOR( 200, 130, 90, 1 ) },
            { LAYER_OP_CURRENTS,            CSS_COLOR( 220, 100, 80, 1 ) },

            // ── GerbView ───────────────────────────────────────────────────
            { LAYER_GERBVIEW_AXES,          CSS_COLOR( 90,  100, 130, 1 ) },
            { LAYER_GERBVIEW_BACKGROUND,    CSS_COLOR( 22,  26,  26,  1 ) },
            { LAYER_DCODES,                 CSS_COLOR( 220, 220, 225, 1 ) },
            { LAYER_GERBVIEW_GRID,          CSS_COLOR( 70,  70,  78,  1 ) },
            { LAYER_NEGATIVE_OBJECTS,       CSS_COLOR( 110, 110, 120, 1 ) },
            { LAYER_GERBVIEW_DRAWINGSHEET,  CSS_COLOR( 90,  100, 130, 1 ) },
            { LAYER_GERBVIEW_PAGE_LIMITS,   CSS_COLOR( 70,  70,  78,  1 ) },
            ...
            // ── PCB / board ────────────────────────────────────────────────
            { LAYER_ANCHOR,                 CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_LOCKED_ITEM_SHADOW,     CSS_COLOR( 200, 120, 60,  0.5 ) },
            { LAYER_CONFLICTS_SHADOW,       CSS_COLOR( 230, 80,  70,  0.5 ) },
            { LAYER_AUX_ITEMS,              CSS_COLOR( 220, 220, 225, 1 ) },
            { LAYER_PCB_BACKGROUND,         CSS_COLOR( 22,  26,  26,  1 ) },
            { LAYER_CURSOR,                 CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_DRC_ERROR,              CSS_COLOR( 215, 91,  107, 0.8 ) },
            { LAYER_DRC_WARNING,            CSS_COLOR( 255, 208, 66,  0.8 ) },
            { LAYER_DRC_EXCLUSION,          CSS_COLOR( 200, 200, 205, 0.8 ) },
            { LAYER_DRC_HIGHLIGHTED,        CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_GRID,                   CSS_COLOR( 70,  70,  78,  1 ) },
            { LAYER_GRID_AXES,              CSS_COLOR( 110, 110, 120, 1 ) },
            { LAYER_PAD_PLATEDHOLES,        CSS_COLOR( 194, 194, 0,   1 ) },
            { LAYER_NON_PLATEDHOLES,        CSS_COLOR( 26,  196, 210, 1 ) },
            { LAYER_RATSNEST,               CSS_COLOR( 200, 120, 60,  0.45 ) },
            { LAYER_SELECT_OVERLAY,         CSS_COLOR( 220, 140, 80,  1 ) },
            { LAYER_VIA_HOLES,              CSS_COLOR( 227, 183, 46,  1 ) },
            { LAYER_VIA_HOLEWALLS,          CSS_COLOR( 200, 200, 200, 1 ) },
            { LAYER_DRAWINGSHEET,           CSS_COLOR( 200, 120, 60,  1 ) },
            { LAYER_PAGE_LIMITS,            CSS_COLOR( 70,  70,  78,  1 ) },
            { LAYER_BOARD_OUTLINE_AREA,     CSS_COLOR( 100, 100, 100, 0.35 ) },
            { NETNAMES_LAYER_ID_START,      CSS_COLOR( 220, 220, 225, 0.7 ) },
            { LAYER_PAD_NETNAMES,           CSS_COLOR( 220, 220, 225, 0.9 ) },
            { LAYER_VIA_NETNAMES,           CSS_COLOR( 50,  50,  50,  0.9 ) },
            { LAYER_POINTS,                 CSS_COLOR( 220, 140, 80,  1 ) },
            ...
            { Eco2_User,                    CSS_COLOR( 216, 200, 82,  1 ) },
            { Edge_Cuts,                    CSS_COLOR( 208, 210, 205, 1 ) },
            { Margin,                       CSS_COLOR( 220, 140, 80,  1 ) },
            { B_CrtYd,                      CSS_COLOR( 38,  233, 255, 1 ) },
            { F_CrtYd,                      CSS_COLOR( 220, 140, 80,  1 ) },
            { B_Fab,                        CSS_COLOR( 88,  93,  132, 1 ) },
            { F_Fab,                        CSS_COLOR( 175, 175, 175, 1 ) },
            { User_1,                       CSS_COLOR( 194, 194, 194, 1 ) },
            { User_2,                       CSS_COLOR( 89,  148, 220, 1 ) },
            ...
            { LAYER_3D_BACKGROUND_BOTTOM,   COLOR4D( 0.10, 0.10, 0.12, 1.0 ) },
            { LAYER_3D_BACKGROUND_TOP,      COLOR4D( 0.16, 0.16, 0.19, 1.0 ) },
            { LAYER_3D_BOARD,               COLOR4D( 0.2,  0.17, 0.09, 0.9 ) },
            { LAYER_3D_COPPER_TOP,          COLOR4D( 0.7,  0.61, 0.0,  1.0 ) },
            { LAYER_3D_SILKSCREEN_BOTTOM,   COLOR4D( 0.9,  0.9,  0.9,  1.0 ) },
            { LAYER_3D_SILKSCREEN_TOP,      COLOR4D( 0.9,  0.9,  0.9,  1.0 ) },
